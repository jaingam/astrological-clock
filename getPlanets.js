...
export const getSaturn = () => {
    ...
    const ringGeometry = new THREE.RingGeometry(earthSize * (6630 + 58232) / earthMeanRaius, earthSize * (120700 + 58232) / earthMeanRaius, 32); //(120,700+58232)/6371.0 //(ring radius+radius)/earthRadius
